...
class Report extends React.Component {
  ...
  state = {
        ...
        <Card style={{backgroundColor: '#131325'}}>
                    <CardItem bordered style={{backgroundColor: '#1e2c3c'}}>
                      <Left>
                        ...
                        <Right>
                        <Icon name="check-circle" type="FontAwesome" color='green'/>
                        </Right>
                      </Left>
                    </CardItem>
                    <CardItem boardered style={{backgroundColor: '#1e2c3c'}}>
                                  ...
                                  <Body>
                                    <Button transparent small warning disabled={this.addButtonStatus(section.package_name)}>
    ...
    constructor(props){
      super(props);
      this.props.navigator.setTitle({title: 'mCerebrum : Report'});
    }
